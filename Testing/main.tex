...
\begin{proof}
 ...
 \end{array}\]
and thus,
\[ \E X \geq t \cdot \E \1_{X\geq t} = t \P\{X \geq t\} \]
\end{proof}
...
% The most commonly used concentration inequalities are based on how far a random variable is from its expected value. The first example illustrates how can
...
\begin{proof}[Proof Theorem~\ref*{ade:T1}]
